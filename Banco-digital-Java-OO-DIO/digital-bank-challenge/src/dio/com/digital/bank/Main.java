...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Cliente felipe = new Cliente("Felipe", bancoInicial);  //criado novo cliente felipe
        felipe.setNome("Felipe Batista Fraga"); //insere o nome do cliente

        Conta ccorrente = new ContaCorrente(felipe); //instanciada nova conta corrente
        ...
        ccorrente.imprimirExtrato();  //imprime extrato de ccorrente felipe
        cpoupanca.imprimirExtrato();  //imprime estrato de cpoupanca alisson

        ccorrente.transferir(48, cpoupanca);  //faz tranferencia de ccorrente felipe pra cpoupanca alisson

        ccorrente.imprimirExtrato(); //imprime extrato atualizado de ccorrente felipe
